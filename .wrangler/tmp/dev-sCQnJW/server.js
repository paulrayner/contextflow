...
// .wrangler/tmp/bundle-pEBa97/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-pEBa97/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// workers/server.ts
var STORAGE_KEY = "yjs-document";
var DEBOUNCE_WAIT_MS = 2e3;
var DEBOUNCE_MAX_WAIT_MS = 1e4;
var SAVE_TIMEOUT_MS = 5e3;
var YjsRoom = class extends YServer {
  ...
  async onLoad() {
    try {
      ...
      console.error(`[YjsRoom] Error loading document for room ${this.name}:`, error3);
    }
  }
  async onSave() {
    try {
      ...
      console.error(`[YjsRoom] Error saving document for room ${this.name}:`, error3);
      throw error3;
    }
  }
};
